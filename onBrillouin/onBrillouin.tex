...
% \begin{frame}
% \frametitle{Light scattering}
% \begin{block}{Brillouin scattering}
%  Interaction of light and material waves within a medium, mediated by the refractive index dependence on the material properties of the medium.
% \end{block}

% \begin{block}{Rayleigh scattering}
% The elastic scattering of light by particles much smaller than the wavelength of the light, involves only the random and incoherent thermal fluctuations, in contrast with the correlated, periodic fluctuations (phonons) that cause Brillouin scattering.
% \end{block}

% \begin{block}{Raman scattering}
% The  inelastic scattering of light caused by the vibrational properties of matter, photons are scattered by the effect of vibrational and rotational transitions in the bonds between first-order neighboring atoms.
% \end{block}
% \end{frame}
